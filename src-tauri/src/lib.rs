...
mod app_init {
    ...
    pub fn generate_handlers() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
        tauri::generate_handler![
            ...
            cmd::generate_age_keypair,
            cmd::import_age_secret_key,
            cmd::export_age_secret_key,
            cmd::delete_age_key,
            cmd::list_age_key_bindings,
            cmd::bind_age_key_to_profiles,
            cmd::unbind_age_key_from_profiles,
            cmd::test_delay,
            cmd::get_app_dir,
            cmd::copy_icon_file,
